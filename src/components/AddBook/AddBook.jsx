...
const AddBook = () => {
  ...
  const handleAddBook=(event)=>{
          ...
          const addBook={
            name,bookImageUrl,authorName,category,quantity,rating,shortdescription,bookContent
          }
  ...
  return (
    <div className="py-10">
      ...
      <div className="w-4/5 max-sm:w-full mx-auto p-10 rounded-xl shadow-2xl">
        <form onSubmit={handleAddBook}  className=" max-sm:w-full max-md:w-full  rounded-xl  border border-gray-300 mx-auto">
          <div className="grid p-10  grid-cols-2  gap-5 max-md:grid-cols-1 max-md:w-full max-sm:w-full max-sm:grid-cols-1 mx-auto">
            ...
            <div className="form-control ">
              ...
              <label className="input-group">
                <textarea
                  placeholder="Write a short about book" required
                  name="bookContent" 
